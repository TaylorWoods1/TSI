                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        {selectedIdeas.map(idea => (
                            <div key={idea.ideaId} className="rounded-lg border bg-background p-4">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <section>
                <div className="mb-6">
                    ...
                    <p className="text-muted-foreground mt-1">What are the specific applications or scenarios for the selected idea(s)?</p>
                </div>
                    ...
                    {isSessionActive && (
                        <Card className="border-dashed bg-muted/50">
                             <CardHeader>
                                ...
                                <CardDescription>Contribute a new application for an idea.</CardDescription>
                            </CardHeader>
                            <CardContent>
                 ...
                 <div className="space-y-4">
                    ...
                    <Card key={sol.solutionId}>
                        <CardHeader className="p-4 pb-2">
                            <CardDescription>
                                For Use Case: <span className="font-medium text-foreground">"{useCases.find(uc => uc.useCaseId === sol.useCaseId)?.description}"</span>
                            </CardDescription>
                        </CardHeader>
                    ...
                    {isSessionActive && useCases.length > 0 && (
                        <Card className="border-dashed bg-muted/50">
                             <CardHeader>
                            ...
                            <CardContent>
                                <form className="space-y-4">
                                    <div className="grid gap-2">
                                        <Label htmlFor="use-case-select">Link to Use Case</Label>
                                        <Select>
                                            <SelectTrigger id="use-case-select">
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Textarea id="solution-description" placeholder="Describe the new solution..."/>
                                    </div>
                                    <Button>
                                        <Plus className="mr-2" />
                                        Submit Solution
